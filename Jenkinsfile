...
pipeline {
  ...
  environment {
    ...
    imageName = "sivakumarr5/numeric-app:${GIT_COMMIT}"
    ...
    stage('Docker Build and Push') {
      steps {
        withDockerRegistry([credentialsId: "docker-hub", url: ""]) {
          sh 'printenv'
          sh 'sudo docker build -t sivakumarr5/numeric-app:""$GIT_COMMIT"" .'
          sh 'docker push sivakumarr5/numeric-app:""$GIT_COMMIT""'
        }
      }
    }
